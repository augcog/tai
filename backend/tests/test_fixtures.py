...
class TestFixtureStructure:
    ...
    def test_request_fixtures_structure(self, fixtures):
        ...
        for fixture in fixtures["requests"]:
            ...
            assert isinstance(fixture["messages"], list), f"'messages' should be a list in {path}"
            assert len(fixture["messages"]) > 0, f"'messages' should not be empty in {path}"
            ...
            if "rag" in fixture:
                assert isinstance(fixture["rag"], bool), f"'rag' should be a boolean in {path}"
