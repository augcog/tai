...
class APITestHelper:
    ...
    def assert_hierarchy_response(response):
        ...
        assert "total_directories" in data, "Response should contain 'total_directories' field"
    ...
    @staticmethod
    def create_mock_file_response(file_path: str, mime_type: str, filename: str) -> FileResponse:
...
class TestDataFactory:
    ...
    def create_file_hierarchy(depth: int = 2, files_per_dir: int = 2) -> Dict[str, Any]:
        ...
        def create_directory(name: str, path: str, current_depth: int) -> Dict[str, Any]:
            children = []
            ...
            if current_depth < depth:
                for i in range(2):  # 2 subdirectories per level
                    ...
                    children.append(create_directory(subdir_name, subdir_path, current_depth + 1))
    ...
    @staticmethod
    def create_file_list(count: int, directory: str = "documents") -> List[local_storage.LocalFile]:
