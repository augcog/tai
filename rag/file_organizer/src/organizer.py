...
class FileOrganizer:
    ...
    async def organize_course(
        ...
        await self._topic_classifier.process_summaries(
            summary_path, topics_classification_path, self.topics
        )
        log.info("✅ Classified topics in %s", course_path.name)
        # Function classification
        await self._func_classifier.process_summaries(
            summary_path, func_classification_path, self.predefined_classification
        )
        log.info("✅ Classified functions in %s", course_path.name)
        # reorganize folder
        organize_files(
            course_path,
            topics_classification_path,
            func_classification_path,
            output_dir,
            move_files=False,
        )
    ...
    async def func_classify_only(
        ...
        await self._func_classifier.process_summaries(
            input_dir, output_path, self.predefined_classification
        )
    ...
    async def topic_classify_only(
        ...
        await self._topic_classifier.process_summaries(
            input_dir, output_path, self.topics
        )
...
if __name__ == "__main__":
    ...
    async def summarize():
        org = FileOrganizer(
            "/Users/lihaichao/Documents/TAI/file_organizer/course_config_sample.yaml"
        )
        await org.summarize_only(
            "/Users/lihaichao/Documents/TAI/file_organizer/tests/CS61A_md/textbook/root",
            "summaries.json",
        )
    ...
    async def topic_classify_summary():
        ...
        await org.topic_classify_only(
            "/Users/lihaichao/Documents/TAI/file_organizer/src/summaries.json",
            "topics2.json",
        )
    ...
    async def main():
        ...
        await org.organize_course(
            "/Users/lihaichao/Documents/TAI/file_organizer/tests/CS61A_md",
