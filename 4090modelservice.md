vllm serve cpatonn/Qwen3-30B-A3B-Thinking-2507-AWQ-4bit --tensor-parallel-size 2 --gpu-memory-utilization 0.47 --max-model-len 10000 --max_num_seqs 32 --reasoning-parser qwen3 --port 8001 --api-key UJnYZomLkoSUUFqvxU30ULBaGISzPfz3
