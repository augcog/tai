...
Integration into Kinetic and Melodic version of MoveIt is work in progress. `More info <http://wiki.ros.org/Papers/ICRA2011_Kalakrishnan?action=AttachFile&do=get&target=kalakrishnan_icra2011.pdf>`_
