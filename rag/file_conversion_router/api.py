...
if __name__ == "__main__": 
    convert_directory("tests\\test_rag\data\integrated_tests\input_folder2_nested_folder_pdf+md\mds", "tests\\test_rag\data\integrated_tests\expected_output_folder2_nested_folder_pdf+md\mds")