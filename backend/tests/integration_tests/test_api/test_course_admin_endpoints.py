...
class TestCourseAdminEndpoints(BaseCourseAdminTest):
    ...
    def update_course(self, course_id: int, course_data: CourseUpdate) -> Optional[CourseModel]:
    ...
    def get_courses(self, skip: int = 0, limit: int = 100) -> Tuple[List[CourseModel], int]:
    ...
    def test_create_duplicate_course_code_returns_400(self, sample_course_data, course_fixture):
    ...
    def test_update_course_with_existing_code_returns_400(self, course_fixture, login_required_course_fixture):
    ...
    def test_regular_user_cannot_access_admin_endpoints(self, regular_client, sample_course_data):
